import { SafeAreaView, StyleSheet, Text, View, Dimensions, Image, TouchableOpacity, TextInput, Modal, FlatList } from 'react-native'
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <View style={{ alignItems: 'center' }}>
                            ...
                            <Modal transparent={true} visible={showModal1} style={{ height: 100 / 924 * height }} >
                                <View style={styles.modalMainVeiw} >
                            ...
                            <Modal transparent={true} visible={showModal2} style={{ height: 100 / 924 * height }} >
                                <View style={[styles.modalMainVeiw, { paddingTop: 450 / 924 * height }]} >
                            ...
                            <Modal transparent={true} visible={showModal3} style={{ height: 100 / 924 * height }} >
                                <View style={[styles.modalMainVeiw, { paddingTop: 460 / 924 * height }]} >
                            ...
                            <Modal transparent={true} visible={showModal4} style={{ height: 100 / 924 * height }} >
                                <View style={[styles.modalMainVeiw, { paddingTop: 580 / 924 * height }]} >
                            ...
                            <Modal transparent={true} visible={showModal5} style={{ height: 100 / 924 * height }} >
                                <View style={[styles.modalMainVeiw, { paddingTop: 650 / 924 * height }]} >
