...
const JournalSnapshotSaveScreen = (props) => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: '#0f0f0f', height: height }}>
            ...
            <View style={{ flex: 1, backgroundColor: '#0f0f0f', alignItems: 'center', justifyContent: 'center' }}>
               ...
               <Text style = {{fontSize:12,fontWeight:'500',color:'#fff',marginTop:25/924*height}}>Check-in saved!</Text>

               <TouchableOpacity style = {{marginTop:50/924*height}} 
                    onPress={()=>props.navigation.replace("WeeklySummaryMainScreen")}
               >
