...
export default TermsAndConditionsScreen = (props) => {
                ...
                <View style={styles.mainView}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center', }}>
                            ...
                            <Text style={globalStyles.capsuleBtnText}>Terms and conditions</Text>
                        </View>
                        <View style={{ height: 36 / 924 * height, width: 10 / 429 * width }}></View>
                    </View>
                    <Text style={{ fontSize: 12, fontWeight: '500', color: '#F8EDDA50', marginTop: 35 / 924 * height, marginBottom: 10 / 924 * height }}>Terms and conditions</Text>
